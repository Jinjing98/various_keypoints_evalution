...
def compute_matching_score(data, keep_k_points=1000):
    ...
    # print("debug2:",keypoints.shape,warped_keypoints.shape)
    ...
    ms = (score1 + score2) / 2
    # print("kps w kps: ",np.array(true_keypoints).shape,np.array(true_warped_keypoints).shape)
    # print("norm1 norm2",np.array(norm1).shape,np.array(norm2).shape)
