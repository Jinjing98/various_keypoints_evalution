...
cfg.arch.epochs = 70                # Maximum number of epochs
########################################################################################################################
### WANDB
########################################################################################################################
cfg.wandb = CN()
...
########################################################################################################################
cfg.model = CN()
cfg.model.checkpoint_path = '/mnt/g27prist/TCO/TCO-Studenten/ariel_research_project/pretrained_models/kp2d/'              # Checkpoint path for model saving
...
cfg.datasets.augmentation.image_shape = (320, 240)              # Image shape
...
cfg.datasets.train.num_workers = 0                                    # Training number of workers
cfg.datasets.train.path = '/mnt/g27prist/TCO/TCO-Studenten/ariel_research_project/raw_dataset_videos/training/dataset/'        # Training data path (COCO dataset)
cfg.datasets.train.repeat = 1                                          # Number of times training dataset is repeated per epoch
########################################################################################################################
### DATASETS.VAL
########################################################################################################################
cfg.datasets.val = CN()
cfg.datasets.val.path = '/home/rodriguar/Desktop/validation/dataset/'     # Validation data path (HPatches)
########################################################################################################################
